...
interface IAddConfettiConfig {
    ...
    emojis?: string[],
    emojiSize?: number,
    // if provided, confetti would be fired from a specified position on the screen,
    // otherwise they would be fired from the sides of the screen (default behavior)
